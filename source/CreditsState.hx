...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		[''],
		['Mod devs'],
		['kawaii',				'kawaii',			'Main artist/Moral support/Leader of mod',						'https://twitter.com/KawaiiMochiORA',			0xFFFFB2F6],
		['maple',				'maple',			'Main Coder/Charter for somev songs',						'https://www.youtube.com/channel/UCLwn0LU8RhRmXzI06iFNukw',			0xFFD72323],
		[''],
		["Funkin' Crew"],
